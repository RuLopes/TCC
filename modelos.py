...
class Perguntas(models.Model):
    ...
    video_pergunta = models.CharField(max_length=500, blank=True, null=True)
    video_alternativa = models.CharField(max_length=500, blank=True, null=True)
